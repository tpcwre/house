...
<?php if($page2['pnum'] > 0): ?><div style='margin-bottom:100px'>
	...
	<?php $__FOR_START_30415__=$page2['pmin'];$__FOR_END_30415__=$page2['pmax'];for($k=$__FOR_START_30415__;$k <= $__FOR_END_30415__;$k+=1){ if($page2['pnow'] == $k): ?><div style='display:inline-block;margin:3px;border:1px solid blue;padding:3px'>
