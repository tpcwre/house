...
<div style='font:normal normal 12px normal;padding-left:15px;margin-bottom:20px'>
	...
	<?php if($page2['pnum'] > 0): ?><div style='margin-bottom:100px'>
		...
		<?php $__FOR_START_28998__=$page2['pmin'];$__FOR_END_28998__=$page2['pmax'];for($k=$__FOR_START_28998__;$k <= $__FOR_END_28998__;$k+=1){ if($page2['pnow'] == $k): ?><div style='display:inline-block;margin:3px;border:1px solid blue;padding:3px;background:#2E6AB1;font-weight:bold'>
