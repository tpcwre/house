...
<?php if($page2['pnum'] > 0): ?><div style='margin-bottom:100px'>
		...
		<?php $__FOR_START_27413__=$page2['pmin'];$__FOR_END_27413__=$page2['pmax'];for($k=$__FOR_START_27413__;$k <= $__FOR_END_27413__;$k+=1){ if($page2['pnow'] == $k): ?><div style='display:inline-block;margin:3px;border:1px solid blue;padding:3px'>
...
<?php $__FOR_START_11818__=$page2['pmin'];$__FOR_END_11818__=$page2['pmax'];for($k=$__FOR_START_11818__;$k <= $__FOR_END_11818__;$k+=1){ if($page2['pnow'] == $k): ?><div style='display:inline-block;margin:3px;border:1px solid blue;padding:3px'>
			<a style='text-decoration:none;color:#000' href='<?php echo ($_SERVER['PHP_SELF']); ?>?pnow=<?php echo ($k); ?>'><?php echo ($k); ?></a>
		</div>	
	<?php else: ?>
		<div style='display:inline-block;margin:3px'>
