...
<!--分页
	...
	<?php $__FOR_START_11824__=$page2['pmin'];$__FOR_END_11824__=$page2['pmax'];for($k=$__FOR_START_11824__;$k <= $__FOR_END_11824__;$k+=1){ if($page2['pnow'] == $k): ?><div style='display:inline-block;margin:3px;border:1px solid blue;padding:3px'>
